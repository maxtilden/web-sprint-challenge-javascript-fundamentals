...
//Because internal is declared in the function myFunction which is a parent funtion to nestedFunction so it can acess the variable, it would not work the other way around.
  ...
  function animalNames(array){
    ...
    const result = [];
     array.forEach(function(item){
       result.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
     })
    return result;
  }
